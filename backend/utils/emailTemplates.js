          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="margin:24px 0;background:#ffffff;border-radius:8px;overflow:hidden;">
            <tr>
              <td style="padding:28px 32px;background:linear-gradient(90deg,#556ee6,#6f42c1);color:#fff;text-align:left;">
                <h1 style="margin:0;font-size:22px;line-height:26px;font-weight:700;">Welcome to {{app_name}}, {{user_name}} 👋</h1>
            ...
            <tr>
              <td style="padding:24px 32px;color:#333333;font-size:15px;line-height:22px;">
                ...
                <p style="margin:0 0 12px;">Thanks for joining <strong>{{app_name}}</strong> — we're excited to help you get going. Here are a few resources to help you make the most out of your account:</p>
                <ul style="margin:0 0 12px;padding-left:18px;">
                  ...
                  <li style="margin-bottom:6px;">Contact support anytime at <a href="mailto:{{support_email}}">{{support_email}}</a></li>
                </ul>

                <p style="margin:0 0 18px;text-align:center;">
                  <a href="#" style="display:inline-block;padding:12px 20px;border-radius:6px;background:#556ee6;color:#fff;text-decoration:none;font-weight:600;">Go to Dashboard</a>
                </p>

                <p style="margin:0;color:#666;font-size:13px;">If you didn't sign up for {{app_name}}, please ignore this email or contact us.</p>
              </td>
            </tr>

            <tr>
              <td style="padding:18px 32px;background:#fafafa;color:#888;font-size:13px;text-align:center;">
                <p style="margin:0;">© {{year}} {{app_name}} — <a href="mailto:{{support_email}}" style="color:#888;text-decoration:underline;">Support</a></p>
              </td>
            </tr>
          </table>
        </td>
          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="margin:24px 0;background:#ffffff;border-radius:8px;overflow:hidden;">
            <tr>
              <td style="padding:22px 28px;background:#111827;color:#fff;text-align:left;">
                <h2 style="margin:0;font-size:18px;">Login to {{app_name}}</h2>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:28px;color:#111827;font-size:15px;line-height:22px;">
                ...
                <p style="margin:0 0 12px;color:#6b7280;font-size:13px;">If you didn't request this, you can safely ignore this email. For help, contact <a href="mailto:{{support_email}}">{{support_email}}</a>.</p>
              </td>
            </tr>

            <tr>
              <td style="padding:14px 28px;background:#fafafa;color:#888;font-size:13px;text-align:center;">
                <p style="margin:0;">Need more help? Reply to <a href="mailto:{{support_email}}">{{support_email}}</a></p>
              </td>
            </tr>
          </table>
        </td>
...
export const verifyEmailOTP = `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
          ...
          <table width="600" cellpadding="0" cellspacing="0" role="presentation" style="margin:24px 0;background:#ffffff;border-radius:8px;overflow:hidden;">
            ...
            <tr>
              <td style="padding:26px;color:#111827;font-size:15px;line-height:22px;">
                ...
                <p style="margin:0;color:#6b7280;font-size:13px;">If you did not create an account or didn't request verification, ignore this message or contact support at <a href="mailto:{{support_email}}">{{support_email}}</a>.</p>
              </td>
            </tr>

            <tr>
              <td style="padding:14px 26px;background:#fafafa;color:#888;font-size:13px;text-align:center;">© {{year}} {{app_name}}</td>
            </tr>
          </table>
        </td>
      </tr>
...
export const resetPasswordLink = `<!doctype html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
